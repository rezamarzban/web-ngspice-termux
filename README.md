...
Assume that PHP server and nginx, ngspice in termux or similar is installed and running. Place `index.php` file from this repository in the root html folder and navigate your browser to your PHP web server address. If PHP server and nginx, ngspice is not installed, Simply run:
